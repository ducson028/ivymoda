...
<body>
    ...
    <div class="content">
            <div class="form">
                ...
                <form action="index.html" class="dangnhap" method="post">
                <input require type="text" name="username" placeholder="Nhập tài khoản">
                <input require type="text" name="password" placeholder="Nhập mật khẩu">
                <input type="submit" name="dangnhap" class="btnn" value='Đăng nhập'/>
                <?php require 'xuly.php';?> 
                <p class="link">Chưa có tài khoản hãy<br>
                <a href="register.php" title="Đăng ký">Đăng Ký </a> ở đây</a></p>
            </form>
